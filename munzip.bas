...
'
' Part of the implementation of cUnzip.cls, a class which gives a simple interface to Info-ZIP's excellent, free unzipping library (Unzip32.DLL).
' This sample uses decompression code by the Info-ZIP group.  The original Info-Zip sources are freely available from their website at
'     http://www.cdrcom.com/pubs/infozip/
'
' Please ensure you visit the site and read their free source licensing information and requirements before using their code in your own application.
...
Private Sub UnzipMessageCallBack(ByVal ucsize As Long, ByVal csiz As Long, ByVal cfactor As Integer, ByVal mo As Integer, ByVal dy As Integer, ByVal yr As Integer, _
      ByVal hh As Integer, ByVal mm As Integer, ByVal c As Byte, ByRef fname As CBCh, ByRef meth As CBCh, ByVal crc As Long, ByVal fCrypt As Byte)
...
On Error GoTo UnzipUnzipPasswordCallBackError
...
' Errors
UnzipUnzipPasswordCallBackError:
MsgBox Error$, vbOKOnly + vbCritical, "UnzipUnzipPasswordCallBack"
ierror = True
Exit Function
